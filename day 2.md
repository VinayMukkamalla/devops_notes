...
**@00:35 AWS server launch using linux**



**client server architecture @ 53mins**
...
create keypairs in daws-86 in local to use to connect to any server or git hub or anything remotely from our personal laptop using public and private key we generated 



using key pairs section in AWS import public key in aws
...
create custom security group(firewall)
...
desc allowing SSH on port 22 from all computers
...
**Firewall and authentication  @ 45mis**
...
Linux Server -> clients -> putty, mobaxterm, cmd, mac terminal, git bash, etc.. **@58 mins**
